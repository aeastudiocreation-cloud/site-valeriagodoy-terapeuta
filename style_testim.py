...
for path in files:
    ...
    new_section = """  <section class="bloco" style="background: sienna; padding-block: var(--e8);">
    <style>
      .depoimento-card {
        background: #fff;
    ...
    <div class="wrap">
      <div class="trilho" style="color: rgba(255,255,255,0.8); border-color: rgba(255,255,255,0.2);"><span>Depoimentos</span></div>
      <h2 style="color: #fff;">O que dizem os clientes sobre o atendimento?</h2>
      <p class="limite" style="color: rgba(255,255,255,0.9);">A experiência de cada pessoa com o processo terapêutico é individual.</p>
      
      <div class="grade grade--3" style="margin-top: var(--e5); align-items: stretch;">
        
        <!-- Depoimento 1 -->
        <div class="card depoimento-card" style="padding: var(--e5); height: 100%; display: flex; flex-direction: column;">
          <svg width="40" height="40" viewBox="0 0 24 24" fill="var(--ouro)" opacity="0.4" style="margin-bottom: 1rem;"><path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1zm14 0c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z"/></svg>
          ...
          <div style="margin-top: var(--e4); border-top: 1px solid rgba(0,0,0,0.1); padding-top: var(--e3);">
            <b style="display: block; font-size: 1.1rem; color: #000;">Ana Lucia Marcondes</b>
        ...
        <div class="card depoimento-card" style="padding: var(--e5); height: 100%; display: flex; flex-direction: column;">
          ...
          <div style="margin-top: var(--e4); border-top: 1px solid rgba(0,0,0,0.1); padding-top: var(--e3);">
            <b style="display: block; font-size: 1.1rem; color: #000;">Marta</b>
        ...
        <div class="card depoimento-card" style="padding: var(--e5); height: 100%; display: flex; flex-direction: column;">
          ...
          <div style="margin-top: var(--e4); border-top: 1px solid rgba(0,0,0,0.1); padding-top: var(--e3);">
            <b style="display: block; font-size: 1.1rem; color: #000;">Katilce Xavier</b>
            <span style="font-size: var(--t-sm); color: var(--cinza);">Cliente de TRG</span>
          </div>
        </div>
...
print("Testimonial styles updated successfully")
