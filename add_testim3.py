    ...
    <div class="grade grade--3" style="margin-top: var(--e5); align-items: stretch;">
      ...
      <div class="card card--bege" style="padding: var(--e5); height: 100%; display: flex; flex-direction: column;">
        ...
        <p style="font-style: italic; font-size: 1.05rem; line-height: 1.6; color: var(--tinta); flex-grow: 1;">
          ...
          Foi então que alguém me indicou a TRG e comecei a fazer essa terapia, achei fantástico. Em poucas sessões já conseguia resolver algumas dificuldades que tinha, como medo. Depois com os meses fui vendo a transformação em minha vida, a ansiedade sumiu, a depressão também, minha autoestima se elevou, comecei a falar em público que era impossível, fiquei uma mulher alegre e feliz com sentido de vida.<br><br>
          ...
          Hoje não tenho sentimentos de morte, graças a Deus e à TRG. Hoje sinto vontade de viver intensamente a vida, feliz e sem culpa. Meu passado foi restaurado. Hoje é só gratidão."
        </p>
        <div style="margin-top: var(--e4); border-top: 1px solid rgba(0,0,0,0.1); padding-top: var(--e3);">
...
print("Third testimonial added successfully")
